            ...
            <div class="panel-body">
                <form name="Cadastro_Cliente" method="post" action="Cadastrar_Cliente">
                    ...
                    <div class="input-group">
                        ...
                        <input name="Nome" type="text" class="form-control" placeholder="Ex: 123.456.789-10" aria-describedby="basic-addon1">
                    </div>
                    <br>
                    ...
                    <div class="input-group">
                        ...
                        <input name="Nome" type="text" class="form-control" placeholder="Ex: 01.123.456-7" aria-describedby="basic-addon1">
                    </div>
                    <br>
                    ...
                    <div class="input-group">
                        ...
                        <input name="Nome" type="text" class="form-control" placeholder="Ex: (11)1234-5678" aria-describedby="basic-addon1">
                    </div>
                    <br>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Ex: Rua dos bobos, 0" aria-describedby="basic-addon1">
                    </div><br>
                    <center>

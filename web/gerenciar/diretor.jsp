<%-- 
    Document   : diretor
    Created on : 30/03/2016, 10:08:12
    Author     : 28226142
--%>
...
<html lang="pt-br">
    ...
    <body>
        ...
        <ol class="breadcrumb">
            ...
            <li class="disabled">Diretor</li>
        </ol><hr>

        
        <!-- Formulario para cadastro -->
        <div class="page-header formularios-center">
            <h1>Cadastro de Diretor<small> para enriquecer seus filmes</small></h1>
        </div>
        
        <!-- Painel de login -->
        <div class="panel panel-default formularios-painel formulario-middle formulario-backround">
            <div class="panel-body">
                <form name="Cadastro_Diretor" method="post" action="Cadastrar_Diretor">
                    ...
                    <!-- Nome -->
                    <label for="basic-url">Nome do diretor </label>

            ...
            <div class="panel-body">
                <form name="Cadastro_Filme" method="post" action="Cadastrar_Filme">
                    ...
                    <div class="form-group">
                        <select Name="Classificacao" class="combobox form-control" placeholder="Selecione uma opção">
                    ...
                    <span class="label label-primary">Necessary</span>
                    <div class="form-group">
                        <select Name="Diretor" class="combobox form-control" placeholder="Selecione uma opção">
                            <option selected="selected"></option>
                            <option value="josé">josé</option>
                            <option value="josé">esoj</option>
                            <option value="josé">sejo</option>
                    ...
                    <div class="form-group">
                        <select Name="Genero" class="combobox form-control" placeholder="Selecione uma opção">
                            <%
                                if(request.getAttribute("ListGenero") != null) {
                                    List lista = (List)request.getAttribute("ListGenero");
                                    for(int i=0; i<lista.size(); i++)
                                        out.println("<option value=" + lista.get(i) + ">" + lista.get(i) + "</option");
                                }
                            %>
                            <c:forEach var="generos" items="${generos}>
                                <option value="${generos.id}"> ${genero.nome} </option>
                            </c:forEach>
                        </select>
                    </div>
                    ...
                    <div class="input-group formulario-middle">
                        ...
                        <input name="DataLancamento" type="text" class="form-control" placeholder="Ex: 11/12/13" aria-describedby="basic-addon1">
                    </div>
                    <br><br>
                    <center>

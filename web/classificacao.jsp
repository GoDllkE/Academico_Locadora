...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="page-header formularios-center">
            <h1>Cadastro de Classificação<small> para facilitar as coisas!</small></h1>
        </div>
        
        <!-- Painel de login -->
        <div class="panel panel-default formularios-painel formulario-middle formulario-backround">
            <div class="panel-body">
                <form name="Cadastrar_Classificacao" method="post" action="Cadastrar_Classificacao">
                    ...
                    <div class="input-group formulario-middle">
                        ...
                        <input name="Descricao" type="text" class="form-control" placeholder="Ex: joão Ninguem" aria-describedby="basic-addon1">
                    </div>
                    <br>
